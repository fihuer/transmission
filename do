...
function run
{
	...
	docker run --rm -dt -P -v ${resume_dir}:/root/.config/transmission-daemon/ -v $download_dir:/downloaded -v $incomplete_dir:/incomplete -v $torrent_dir:/torrent aimnor/transmission $1
}
